...
void GetTriggerSubset::Loop(TString outputname)
{
	...
	for (Long64_t jentry=0; jentry<nentries;jentry++) {
		...
		bool flag = 0;
		if (outputname == "Charmonium_Jpsi") flag = ((trigger&73)==0 || (trigger&512)!=0 || dimuon_p4->M()<2.7 || dimuon_p4->M()>3.35); 
		...
		else if (outputname == "MuOnia_Upsilon") flag = ((trigger&36)==0 || (trigger&512)!=0 || dimuon_p4->M()<8.3 || dimuon_p4->M()>11.7);
